(function () {
    ...
    var D = C("Opera") || C("OPR"),
        E = C("Edge") || C("Trident") || C("MSIE"),
        F = C("Gecko") && !(-1 != z.toLowerCase().indexOf("webkit") && !C("Edge")) && !(C("Trident") || C("MSIE")) && !C("Edge"),
        G = -1 != z.toLowerCase().indexOf("webkit") && !C("Edge"),
        H = function () {
            var a = z;
    ...
    function V(a, b, d) {
        ...
        if (b) {
            ...
            if (a.top == a) e = 0;
                ...
                if (g) e = g[g.length - 1] == a.location.origin ? 1 : 2;
                else {
                    g = a.top;
                    try {
                        var h;
    ...
    function ca(a, b, d, c) {
        ...
        var e = W(a) + "//" + X(c) + "/pagead/" + [c.google_remarketing_only ? "viewthroughconversion/" : "conversion/", P(c.google_conversion_id), e, "random=", P(c.google_conversion_time)].join(""),
            g = d ? q(d) : "0",
            h;
        a: {
    ...
    function ha(a) {
        ...
        J = new I(1, 2, 3);
        "https:" == W(n) || y || ea.test(navigator.userAgent) || J && K(["42631043", "42631044"], x, 2);
        return !0
    }
    ...
    (function (a, b, d) {
        if (a)
            if (null != /[\?&;]google_debug/.exec(document.URL)) ka(a);
            else {
                try {
                    if (ha(a))
                        if (3 == q(d)) {
                        ...
                        } else d.write(Y(a, b, d, a)), a.google_remarketing_for_search && !a.google_conversion_domain && Z(a, d, a)
                } catch (g) {}
                ia(a)
            }
